    ...
    <main>
      <div className="shell">
        ...
        <section className="awardsSection" id="awards" aria-labelledby="awardsTitle">
          ...
          <div className="awardGrid"><article><div className="awardImage"><img src="/evidence/award-ctf-second.png" alt="인프라 10기 CTF 대회 2등 상장" loading="lazy" /></div><p>01 / CTF COMPETITION</p><h3>CTF 대회 2등</h3></article><article><div className="awardImage"><img src="/evidence/award-wargame-third.png" alt="인프라 10기 워게임 3등 상장" loading="lazy" /></div><p>02 / WARGAME</p><h3>워게임 3등</h3></article></div>
        </section>
